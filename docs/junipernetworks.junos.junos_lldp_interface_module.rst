.. _junipernetworks.junos.junos_lldp_interface_module:
...
**(deprecated, removed after 2022-06-01) Manage LLDP interfaces configuration on Juniper JUNOS network devices**
