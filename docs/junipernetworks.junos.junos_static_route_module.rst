.. _junipernetworks.junos.junos_static_route_module:
...
**(deprecated, removed after 2022-06-01) Manage static IP routes on Juniper JUNOS network devices**
...
:Alternative: Use :ref:`junipernetworks.junos.junos_static_routes <junipernetworks.junos.junos_static_routes_module>` instead.
