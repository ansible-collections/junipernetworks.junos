.. _junipernetworks.junos.junos_bgp_address_family_module:
...
**Manage BGP Address Family attributes of interfaces on Junos devices.**
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>Specify limit for maximum number of prefixes accepted from a peer.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Specify timeout before attempting to restart peer.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Specify maximum number of prefixes accepted from a peer.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Clear peer connection on reaching limit.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Advertise multiple paths to peer.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Receive multiple paths from peer.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Send multiple paths to peer.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Specify number of backup paths to advertise.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Include only multipath contributor routes.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Configure how to select add-path routes.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Advertise all paths allowed by path count.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Advertise equal cost paths.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Perform add-path only for prefixes that match policy.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Aggregate labels of incoming routes with the same FEC.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Community to identify the FEC of incoming routesC.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Set Aggregate labels of incoming routes with the same FEC</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Allow sending and receiving of AIGP attribute.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Dn not allow sending and receiving of AIGP attribute.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td colspan="6">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>defer_initial_multipath_build</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">dictionary</span>
                    </div>
                ...
                <td>
                        <div>Defer initial multipath build until EOR is received.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Max delay(sec) multipath build after peer is up.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Set defer initial multipath build.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td colspan="6">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>delay_route_advertisements</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">dictionary</span>
                    </div>
                ...
                <td>
                        <div>Delay route updates for this family until FIB-sync.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Set max delay advertisement route age.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td colspan="5">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>min_delay_inbound_convergence</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                    </div>
                ...
                <td>
                        <div>Set min delayadvertisement after source-peer sent all routes.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Set min delay advertisement route age.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Set delay route advertisements.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Use entropy label for entropy label capable BGP LSPs.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Policy to select BGP LSPs to use entropy label.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Don&#x27;t validate next hop field against route next hop.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Set entropy-label attribute.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Advertise explicit null.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Advertise explicit null only for connected routes.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Set explicit-null attribute.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Enable extended nexthop encoding.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Resolve using extended color nexthop.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td colspan="6">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>graceful_restart_forwarding_state_bit</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">string</span>
                    </div>
            ...
            <tr>
                ...
                <td>
                        <div>Configure legacy redirect to IP support.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Accept legacy encoded redirect-to-ip action attribute</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Advertise Redirect action as legacy redirect attribute.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Set the legacy-redirect-ip-action.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <div>Specify local IPv4 address.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Allow local AS in received AS paths.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Dont install received routes in forwarding.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Bypass validation procedure for routes that match policy.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td colspan="6">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>output_queue_priority_expedited</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
            ...
            <tr>
                ...
                <td colspan="6">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>output_queue_priority_priority</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                    </div>
            ...
            <tr>
                ...
                <td>
                        <div>Advertise prefixes with unique labels per group.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Allocate a unique label to each advertised prefix.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Limit maximum number of prefixes from a peer.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Specify maximum number of prefixes from a peer.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Install received NLRI in inet.3 also.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Select table used by labeled unicast routes.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Name of the routing table group.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td colspan="6">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>route_refresh_priority_expedited</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
            ...
            <tr>
                ...
                <td colspan="6">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>route_refresh_priority_priority</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                    </div>
            ...
            <tr>
                ...
                <td colspan="6">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>secondary_independent_resolution</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
                ...
                <td>
                        <div>Resolve FLOW routes in VRF table independent of VPN FLOW route.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Strip the next-hop from the outgoing flow update.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Multi topology routing tables.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Collect statistics for BGP label-switched paths</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Statistics file options.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Name of file in which to write trace information.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Maximum trace file size.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Time to collect statistics (seconds).</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Enable ingress labeled path statistics.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td>
                        <div>Set traffic-statistics.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                        <ul style="margin: 0; padding: 0"><b>Choices:</b>
                                    ...
                                    <li>multicast</li>
                                    <li>segment-routing-te</li>
                                    <li>unicast</li>
                                    <li>signaling</li>
                                    <li>auto-discovery-mspw</li>
                                    <li>auto-discovery-only</li>
                        </ul>
                </td>
                <td>
                        <div>Specify type of NLRI.</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
                ...
                <td colspan="6">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>withdraw_priority_expedited</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">boolean</span>
                    </div>
            ...
            <tr>
                ...
                <td colspan="6">
                    <div class="ansibleOptionAnchor" id="parameter-"></div>
                    <b>withdraw_priority_priority</b>
                    <a class="ansibleOptionLink" href="#parameter-" title="Permalink to this option"></a>
                    <div style="font-size: small">
                        <span style="color: purple">integer</span>
                    </div>
            ...
            <tr>
                ...
                <td>
                        <div>Specify address family config for groups.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Specify address family config per neighbor.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        ...
                        <div>State <em>deleted</em> only removes BGP address family attributes that this modules manages and does not negate the BGP neighbor address family completely. Thereby, preserving address-family related configurations under BGP group neighbor context.</div>
                        <div>To delete the address family associated to neighbor use <span class='module'>junipernetworks.junos.junos_bgp_neighbor_address_family</span> modules for prior cleanup.</div>
