...
class Security_policies_globalArgs(object):  # pylint: disable=R0903
    ...
    argument_spec = {'config': {'options': {'default_policy': {'choices': ['deny-all',
                                                       'permit-all'],
                                           'type': 'str'},
                        'policy_rematch': {'options': {'enable': {'type': 'bool'},
                                                       'extensive': {'type': 'bool'}},
                                           'type': 'dict'},
                        'policy_stats': {'options': {'enable': {'type': 'bool'},
                                                     'system_wide': {'type': 'bool'}},
                                         'type': 'dict'},
                        'pre_id_default_policy_action': {'options': {'log': {'options': {'session_close': {'type': 'bool'},
                                                                                         'session_init': {'type': 'bool'}},
                                                                             'type': 'dict'},
                                                                     'session_timeout': {'options': {'icmp': {'type': 'int'},
                                                                                                     'icmp6': {'type': 'int'},
                                                                                                     'ospf': {'type': 'int'},
                                                                                                     'others': {'type': 'int'},
                                                                                                     'tcp': {'type': 'int'},
