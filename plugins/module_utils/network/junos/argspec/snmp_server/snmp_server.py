                        ...
                        'proxies': {'elements': 'dict',
                                    'options': {'device_name': {'type': 'str'},
                                                ...
                                                'version_v3': {'options': {'context': {'type': 'bool'},
                                                               ...
                                                               'type': 'dict'}},
                                    'type': 'list'},
                        'rmon': {'options': {'alarms': {'elements': 'dict',
                                                        'options': {'description': {'type': 'str'},
                                                                    ...
                                                                    'id': {'type': 'str'},
                                                                    'interval': {'type': 'int'},
                                                                    'request_type': {'choices': ['get-next-request',
                                                                                                 'get-request',
                                                                                                 'walk-request'],
                                                                                     'type': 'str'},
                                                                    'rising_event_index': {'type': 'int'},
                                                                    'rising_threshold': {'type': 'int'},
                                                                    'sample_type': {'choices': ['absolute-value',
                                                                                                'delta-value'],
                                                                                    'type': 'str'},
                                                                    'startup_alarm': {'choices': ['falling-alarm',
                                                                                                  'rising-alarm',
