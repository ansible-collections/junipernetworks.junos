...
class Ntp_globalArgs(object):  # pylint: disable=R0903
    ...
    argument_spec = {'config': {'options': {'authentication_keys': {'elements': 'dict',
                                                'options': {'algorithm': {'choices': ['md5',
                                                                                      'sha1',
                                                                                      'sha256'],
                                                                          'type': 'str'},
                                                            'id': {'type': 'int'},
                        ...
                        'servers': {'elements': 'dict',
                                    'options': {'key': {'type': 'int'},
                                                ...
                                                'version': {'type': 'int'}},
                                    'type': 'list'},
                        'source_addresses': {'elements': 'dict',
                                             'options': {'routing_instance': {'type': 'str'},
                                                         'source_address': {'type': 'str'}},
                                             'type': 'list'},
                        'threshold': {'options': {'action': {'choices': ['accept',
                                                                         'reject'],
                                                             'type': 'str'},
                                                  'value': {'type': 'int'}},
                                      'type': 'dict'},
